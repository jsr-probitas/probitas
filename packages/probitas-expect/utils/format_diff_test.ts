...
describe("formatDiff", () => {
  describe("with objects", () => {
    it("shows diff for different object values", () => {
    ...
    it("shows diff with proper indentation", () => {
    ...
    it("returns undefined when objects are equal", () => {
      const actual = { name: "Alice" };
  ...
  describe("with arrays", () => {
    it("shows diff for different array elements", () => {
      const actual = [1, 2, 3];
  ...
  describe("with primitives", () => {
    it("returns undefined for both primitives", () => {
    ...
    it("returns diff when one is object and one is primitive", () => {
  ...
  describe("with color theme", () => {
    it("applies failure color to removed lines and success color to added lines", () => {
      const actual = { name: "Alice" };
      const expected = { name: "Bob" };
    ...
    it("applies dim color to common lines", () => {
